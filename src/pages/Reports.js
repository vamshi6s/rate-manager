...
export default class Reports extends Component {
    ...
    handleDropdown = (location,objectArray,building,unittype,filter) => {
        this.setState({location,objectArray,building,unittype,filter});
    };
    ...
    render(){ 
        const {location,objectArray,building,unittype,filter,amenity,date,acceptance} = this.state;
    return (
      <section className='mt-30px'>
            ...
            <div className='block position-relative '>
              ...
              <div className='Container-table m-auto border-radius-t-0 '>
